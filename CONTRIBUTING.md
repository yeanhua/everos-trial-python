...
modify the contents of the `src/everostrial/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/yeanhua/everos-trial-python.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/yeanhua/everos-trial-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
